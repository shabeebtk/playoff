...
function Bookings() {
    ...
    useEffect(() => {
        ...
        axios.get(`${BaseUrl}owner/bookings`, {
            headers: {
    ...
    return (
        <div className="w-full  h-[100%] p-5">
            <div className="flex justify-between mb-5 ">
                <h1 className="text-xl font-semibold underline">bookings</h1>
                <div><IoMdRefresh className="cursor-pointer" onClick={() => setupdateBookings(!updatedBookings)} /></div>
            </div>

            {allBookingRequests ? allBookingRequests.map((booking, index) => (
                <div key={index}>
                    ...
                    <div className="border-b-2 grid grid-cols-12 p-3 pl-5 pr-2 md:pr-12 items-center rounded-md shadow-sm mb-4">
